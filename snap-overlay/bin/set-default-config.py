...
def _get_default_config():
    ...
    return {
        ...
        'config.network.ext-gateway': '192.168.0.1',
        'config.network.control-ip': '192.168.0.1',
        'config.network.compute-ip': '192.168.0.1',
        'config.network.ext-cidr': '192.168.0.159/24',
